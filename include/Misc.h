...
// App config
#define APP_NAME "NuTracer"
#define APP_VERSION "1.0r0"
#define APP_DESC "A simple C-like interpreter and trace generator for NuCachis."
#define APP_WEB "Arquitectura y Tecnología de Computadores, Universidad de Cantabria (https://www.atc.unican.es)"
